...
if (!empty($error)) {
 ...
 if (!empty($phone)) $e_reply .= " or via phone $phone." . PHP_EOL . PHP_EOL;

 $e_reply .= " $name found you via: $optionsRadios" . PHP_EOL . PHP_EOL;

 $e_reply .= "Subscribe $name for updates: $subscribe";
